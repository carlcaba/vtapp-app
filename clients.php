<?
	...
	$result = checkSession("clients.php",true);
		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"><i class="fa fa-briefcase"></i> <?= $_SESSION["CLIENTS"] ?></h1>
						</div>
						<!-- /.col -->
<?
...
?>
    ...
    <script>
	var fields = ["CLIENT_ID", "CLIENT_NAME", "ADDRESS", "PHONE", "COUNTRY", "CONTACT_NAME", "EMAIL", "IS_BLOCKED", "COUNTRY_ID"];
...
?>
	...
	function show(id, action) {
		if(action != "new")
			location.href = "client-management.php?id=" + id + "&action=" + action;
		else 
			location.href = "client-management.php?action=" + action;
	}
