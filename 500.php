			...
			<aside class="main-sidebar  elevation-4 <?= $skin[1] ?>" style="min-height: 772px;">
				...
				<div class="sidebar">
					...
					<div class="user-panel mt-3 pb-3 mb-3 d-flex">
						<div class="brand-link"><span class="brand-text">Error 500</span></div>
					</div>
					<!-- Sidebar Menu -->
				<!-- /.sidebar-menu -->
				</div>
			...
			<div class="content-wrapper">
				...
				<div class="content-header">
					<div class="container-fluid">
						<div class="row mb-2">
							<div class="col-sm-6">
								<h1 class="m-0 text-dark"><?= $_SESSION["ERROR_PAGE"] ?> 500</h1>
							</div>
							<!-- /.col -->
							<div class="col-sm-6">
								<ol class="breadcrumb float-sm-right">
									<li class="breadcrumb-item"><a href="dashboard.php"><?= $_SESSION["MENU_1"] ?></a></li>
									<li class="breadcrumb-item active"><?= $_SESSION["ERROR_PAGE"] ?> 500</li>
								</ol>
							</div>
							<!-- /.col -->
						</div>
				...
				<section class="content">
					<div class="error-page">
						<h2 class="headline text-warning"> 500 <?= 	url() ?></h2>
						<br />
						<h3><i class="fa fa-warning text-warning"></i> <?= $_SESSION["OOPS_PAGE_INTERNAL_ERROR"] ?></h3>
