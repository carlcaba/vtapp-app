<?
	...
	$ds = $root . $sep;
	$fname = "resource_" . $_SESSION["vtappcorp_userid"] . "_" . date("YmdHis") . "." . pathinfo($_FILES['file2Upload']['name'], PATHINFO_EXTENSION);
	$storeFolder = 'uploads';
	...
	try {
		...
		*/
		...
		$result["message"] = $_SESSION["AN_ERROR_OCCURRED"] . " " . $e->getMessage() . " " . $fname . " " . print_r($_FILES);
