		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"><i class="fa fa-paper-plane"></i> <?= $_SESSION["MENU_NEW"] . " " . $_SESSION["OUTPUT"] ?></h1>
						</div>
						<!-- /.col -->
<?
...
?>
		...
		$("#btnSaveOutput").click(function() {
			...
			$("#btnActivate").bind("click", function() {
				var noty;
				$.ajax({
					url: "core/actions/_save/__newOutput.php",
					data: { strModel: datas },
					dataType: "json",
	...
	function newItem() {
		...
		$('#cbProduct').on('select2:select', function (e, clickedIndex, isSelected, previousValue) {
			...
			data.factormoney = parseFloat(data.factormoney);
			var focus = "txtQUANTITY";
			$("#txtQUANTITY").attr("disabled", (data.productQuantity == 0 || data.productPrice == 0)) ;
