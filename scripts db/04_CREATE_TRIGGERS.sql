...
-- ADDRESS TYPE
DROP TRIGGER IF EXISTS TBL_SYSTEM_ADDRESS_TYPE_INSERT//
CREATE TRIGGER TBL_SYSTEM_ADDRESS_TYPE_INSERT
AFTER INSERT
	ON TBL_SYSTEM_ADDRESS_TYPE FOR EACH ROW
...
BEGIN
	...
	IF vUser <> 'root' THEN	-- Find IP of person performing the INSERT into table
		...
		-- Define the transaction
		SET vTranx = CONCAT('Add /ADDRESS_TYPE/ ',NEW.NAME,' ',NEW.ABBREVIATION,' Id:',NEW.ID);
...
-- PARTNER RATE
DROP TRIGGER IF EXISTS TBL_PARTNER_RATE_INSERT//
CREATE TRIGGER TBL_PARTNER_RATE_INSERT
AFTER INSERT
	ON TBL_PARTNER_RATE FOR EACH ROW
...
BEGIN
	...
	IF vUser <> 'root' THEN	-- Find IP of person performing the INSERT into table
		...
		-- Define the transaction
		SET vTranx = CONCAT('Add /PARTNER_RATE/ ',NEW.DISTANCE_MIN,' ',NEW.DISTANCE_MAX,' ',NEW.TIME_MIN,' ',NEW.TIME_MAX,' Id:',NEW.ID);
...
-- USER ADDRESSES
DROP TRIGGER IF EXISTS TBL_USER_ADDRESSES_INSERT//
CREATE TRIGGER TBL_USER_ADDRESSES_INSERT
AFTER INSERT
	ON TBL_USER_ADDRESSES FOR EACH ROW
...
BEGIN
	...
	IF vUser <> 'root' THEN	-- Find IP of person performing the INSERT into table
		...
		-- Define the transaction
		SET vTranx = CONCAT('Add /USER_ADDRESSES/ ',NEW.ADDRESS_NAME,' ',NEW.ADDRESS,' Id:',NEW.ID);
	...
	IF vUser <> 'root' THEN
		...
		IF vVersion >= 5.7 THEN
			...
			SELECT JSON_OBJECT('USER_ID', OLD.USER_ID,
								...
								'TOTAL_WIDTH', OLD.TOTAL_WIDTH,
								'TOTAL_HEIGHT', OLD.TOTAL_HEIGHT,
								'TOTAL_LENGTH', OLD.TOTAL_LENGTH,
			...
			SELECT JSON_OBJECT('USER_ID', NEW.USER_ID,
								...
								'TOTAL_WIDTH', NEW.TOTAL_WIDTH,
								'TOTAL_HEIGHT', NEW.TOTAL_HEIGHT,
								'TOTAL_LENGTH', NEW.TOTAL_LENGTH,
...
-- ADDRESS TYPE TABLE
DROP TRIGGER IF EXISTS TBL_SYSTEM_ADDRESS_TYPE_UPDATE//
CREATE TRIGGER TBL_SYSTEM_ADDRESS_TYPE_UPDATE
AFTER UPDATE
   ON TBL_SYSTEM_ADDRESS_TYPE FOR EACH ROW
...
BEGIN
	...
	IF vUser <> 'root' THEN
		...
		IF vVersion >= 5.7 THEN
			-- GeneZONEs JSON object for trace
			SELECT JSON_OBJECT('NAME', OLD.NAME,
								'ABBREVIATION', OLD.ABBREVIATION,
								'IS_BLOCKED', OLD.IS_BLOCKED)
				INTO vOld;

			-- GeneZONEs JSON object for trace
			SELECT JSON_OBJECT('NAME', NEW.NAME,
								'ABBREVIATION', NEW.ABBREVIATION,
								'IS_BLOCKED', NEW.IS_BLOCKED)
				INTO vNew;
		ELSE
			-- GeneZONEs STRING object for trace
			SELECT CONCAT(' NAME:', OLD.NAME,
							' ABBREVIATION:', OLD.ABBREVIATION,
							' IS_BLOCKED:', OLD.IS_BLOCKED)
				INTO vOld;

			-- GeneZONEs STRING object for trace
			SELECT CONCAT(' NAME:', NEW.NAME,
							' ABBREVIATION:', NEW.ABBREVIATION,
							' IS_BLOCKED:', NEW.IS_BLOCKED)
				INTO vNew;
		END IF;
		...
		-- Define the transaction
		SET vTranx = CONCAT('Update ADDRESS_TYPE Id:',NEW.ID);

		-- Insert record into log table
		INSERT INTO TBL_SYSTEM_LOG (ID,USER_IP,USER_ID,LOGDATE,TEXT_TRANSACTION) VALUES (0,vIPClient,NEW.MODIFIED_BY,SYSDATE(),vTranx);

		-- Insert the trace 
		INSERT INTO TBL_SYSTEM_TRACE (ID,LOG_ID,TABLE_ORIGIN,RECORD_ID,OLD_RECORD,NEW_RECORD) VALUES (0,LAST_INSERT_ID(),'TBL_SYSTEM_ADDRESS_TYPE',NEW.ID,LEFT(CONVERT(vOld USING utf8),4000),LEFT(CONVERT(vNew USING utf8),4000));
...
-- PARTNER RATE TABLE
DROP TRIGGER IF EXISTS TBL_PARTNER_RATE_UPDATE//
CREATE TRIGGER TBL_PARTNER_RATE_UPDATE
AFTER UPDATE
   ON TBL_PARTNER_RATE FOR EACH ROW
...
BEGIN
	...
	IF vUser <> 'root' THEN
		...
		IF vVersion >= 5.7 THEN
			...
			SELECT JSON_OBJECT('PARTNER_ID', OLD.PARTNER_ID,
								'VEHICLE_TYPE_ID', OLD.VEHICLE_TYPE_ID,
								'DISTANCE_MIN', OLD.DISTANCE_MIN,
								'DISTANCE_MAX', OLD.DISTANCE_MAX,
								'TIME_MIN', OLD.TIME_MIN,
								'TIME_MAX', OLD.TIME_MAX,
								'PRICE', OLD.PRICE,
								'ROUND_TRIP', OLD.ROUND_TRIP,
								'IS_BLOCKED', OLD.IS_BLOCKED)
				INTO vOld;
		...
		-- Define the transaction
		SET vTranx = CONCAT('Update PARTNER RATE Id:',NEW.ID);

		-- Insert record into log table
		INSERT INTO TBL_SYSTEM_LOG (ID,USER_IP,USER_ID,LOGDATE,TEXT_TRANSACTION) VALUES (0,vIPClient,NEW.MODIFIED_BY,SYSDATE(),vTranx);

		-- Insert the trace 
		INSERT INTO TBL_SYSTEM_TRACE (ID,LOG_ID,TABLE_ORIGIN,RECORD_ID,OLD_RECORD,NEW_RECORD) VALUES (0,LAST_INSERT_ID(),'TBL_PARTNER_RATE',NEW.ID,LEFT(CONVERT(vOld USING utf8),4000),LEFT(CONVERT(vNew USING utf8),4000));
...
DROP TRIGGER IF EXISTS TBL_USER_ADDRESSES_UPDATE//
CREATE TRIGGER TBL_USER_ADDRESSES_UPDATE
AFTER UPDATE
   ON TBL_USER_ADDRESSES FOR EACH ROW
...
BEGIN
	...
	IF vUser <> 'root' THEN
		...
		IF vVersion >= 5.7 THEN
			-- GeneZONEs JSON object for trace
			SELECT JSON_OBJECT('USER_ID', OLD.USER_ID,
								'ADDRESS_NAME', OLD.ADDRESS_NAME,
								'ADDRESS', OLD.ADDRESS,
								'ZONE_ID', OLD.ZONE_ID,
								'CITY_ID', OLD.CITY_ID,
								'LATITUDE', OLD.LATITUDE,
								'LONGITUDE', OLD.LONGITUDE,
								'IS_ORIGIN', OLD.IS_ORIGIN,
								'IS_BLOCKED', OLD.IS_BLOCKED)
				INTO vOld;
		...
		-- Define the transaction
		SET vTranx = CONCAT('Update USER ADDRESSES Id:',NEW.ID);

		-- Insert record into log table
		INSERT INTO TBL_SYSTEM_LOG (ID,USER_IP,USER_ID,LOGDATE,TEXT_TRANSACTION) VALUES (0,vIPClient,NEW.MODIFIED_BY,SYSDATE(),vTranx);

		-- Insert the trace 
		INSERT INTO TBL_SYSTEM_TRACE (ID,LOG_ID,TABLE_ORIGIN,RECORD_ID,OLD_RECORD,NEW_RECORD) VALUES (0,LAST_INSERT_ID(),'TBL_USER_ADDRESSES',NEW.ID,LEFT(CONVERT(vOld USING utf8),4000),LEFT(CONVERT(vNew USING utf8),4000));
