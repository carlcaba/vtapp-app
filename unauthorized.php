		...
		<div class="content-wrapper">
			...
			<div class="content-header">
				<div class="container-fluid">
					<div class="row mb-2">
						<div class="col-sm-6">
							<h1 class="m-0 text-dark"> 403 <?= $_SESSION["ERROR_PAGE"] ?></h1>
						</div>
						<!-- /.col -->
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								<li class="breadcrumb-item"><a href="dashboard.php"><?= $_SESSION["MENU_1"] ?></a></li>
								<li class="breadcrumb-item active">403 <?= $_SESSION["ERROR_PAGE"] ?></li>
							</ol>
						</div>
						<!-- /.col -->
					</div>
			...
			<section class="content">
				<div class="error-page">
					...
					<div class="error-content">
						<h3><i class="fa fa-warning text-warning"></i> <?= $_SESSION["OOPS_UNAUTHORIZED"] ?></h3>
						<p><?= $_SESSION["SORRY"] . " " . $_SESSION['ACCESS_RESTRICTED'] . " " . $_SESSION['BACK_SEARCH_MESSAGE']?></p>
